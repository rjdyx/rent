        ...
        <form id="form-household-base-msg">
            <table>
                <tr>
                    ...
                    <td>
                        <input id="jobNumber" name="jobNumber" type="text"/>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td class="td-right">
                        <input type="text" id="has-house-time" name="hasHouseTime" value="" readonly="readonly">
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="text" id="dimission-time" name="dimissionTime" value="" readonly="readonly">
                    </td>
                </tr>
            </table>
        </form>
